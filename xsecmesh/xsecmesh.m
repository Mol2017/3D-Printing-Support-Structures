function [polyCell,nbrFaces] = xsecmesh(plane, mesh, varargin)
...
verts=mesh.vert;
faces=mesh.face;
adjacency_matrix=mesh.adjacency_matrix;
...
if any(truncate_matrix_values(~distArray, nSigFig))
    ...
    for faceNum = 1:size(faces, 1)
        ...
        if tfFaceIntersect % Find the intersection points' coordinates.
            ...
            for edgeNum = 1:NUM_EDGES_PER_FACE
                ...
                p1_index = faceVertIxList(edgeNum);
                p2_index = faceVertIxList(edgeNum+1);
                %tfEdgeChecked = query_edge_intersect_checked(p1, p2, edgeCheckedMat);
                    ...
                    if tfEdgeIntersect
                        ...
                        ixsFacesContainingPoint = [full(adjacency_matrix(p1_index,p2_index)),...
                            full(adjacency_matrix(p2_index,p1_index))];
    ...
    if ~tfIntPointVertexEqual
        ...
        intPts = intPts(1:2:end,:);
        nbrFaces = nbrFaces(1:2:end,:);
